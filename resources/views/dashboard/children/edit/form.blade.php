...
<form action="" method="POST" enctype="multipart/form-data" id="child_update_form">
    @csrf
    @method('PUT')
    ...
    <div class="step" id="step1">
        @include('dashboard.children.edit.child-info')
    </div>

    <div class="step" id="step2" style="display: none;">
        @include('dashboard.children.edit.child-parents')
    </div>

    <div class="step" id="step3" style="display: none;">
        @include('dashboard.children.edit.child-guardian')
    </div>

    <div class="step" id="step4" style="display: none;">
        @include('dashboard.children.edit.child-file')
    </div>

    <div class="step" id="step5" style="display: none;">
        @include('dashboard.children.edit.confirmations')
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        //submit
        $(document).on('submit', '#child_update_form', function(e) {
            e.preventDefault();
            ...
            var url = "{!! route('dashboard.children.update', 'id') !!}".replace('id', id);

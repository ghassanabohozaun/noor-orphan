    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" id="number_of_people_including_mother" name="number_of_people_including_mother"
                ...
                value="{!! $child->childFamily->number_of_people_including_mother !!}">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" id="male_number" name="male_number" class="form-control" autocomplete="off"
                placeholder="{!! __('children.enter_male_number') !!}" value="{!! $child->childFamily->male_number !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" id="female_number" name="female_number" class="form-control" autocomplete="off"
                placeholder="{!! __('children.enter_female_number') !!}" value="{!! $child->childFamily->female_number !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" id="father_full_name_ar" name="father_full_name_ar" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_father_full_name_ar') !!}" value="{!! $child->childFather->getTranslation('father_full_name', 'ar') !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" id="father_full_name_en" name="father_full_name_en" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_father_full_name_en') !!}" value="{!! $child->childFather->getTranslation('father_full_name', 'en') !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" id="father_personal_id" name="father_personal_id" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_father_personal_id') !!}" value="{!! $child->childFather->father_personal_id !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="date" id="father_date_of_death" name="father_date_of_death" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_father_date_of_death') !!}" value="{!! $child->childFather->father_date_of_death !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select id="father_respon_of_death" name="father_respon_of_death" class="form-control">
                ...
                <option value="illness" {!! $child->childFather->father_respon_of_death == 'illness' ? 'selected' : '' !!}>{!! __('children.illness') !!}</option>
                <option value="martyr" {!! $child->childFather->father_respon_of_death == 'martyr' ? 'selected' : '' !!}>{!! __('children.martyr') !!}</option>
            </select>
            <span class="text text-danger">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" id="mother_full_name_ar" name="mother_full_name_ar" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_mother_full_name_ar') !!}" value="{!! $child->childMother->getTranslation('mother_full_name', 'ar') !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" id="mother_full_name_en" name="mother_full_name_en" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_mother_full_name_en') !!}" value="{!! $child->childMother->getTranslation('mother_full_name', 'en') !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="mother_personal_id" name="mother_personal_id" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_mother_personal_id') !!}" value="{!! $child->childMother->mother_personal_id !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="date" id="mother_date_of_death" name="mother_date_of_death" class="form-control"
                autocomplete="off" placeholder="{!! __('children.enter_mother_date_of_death') !!}" value="{!! $child->childMother->mother_date_of_death !!}">
            <span class="text text-danger">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select id="is_mother_alive" name="is_mother_alive" class="form-control">
                <option value="" selected>{!! __('children.select_from_list') !!}</option>
                <option value="0" {!! $child->childMother->is_mother_alive == '0' ? 'selected' : '' !!}>{!! __('children.no') !!}</option>
                <option value="1" {!! $child->childMother->is_mother_alive == '1' ? 'selected' : '' !!}>{!! __('children.yes') !!}</option>
            </select>
            <span class="text text-danger">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select id="is_mother_the_guardian" name="is_mother_the_guardian" class="form-control">
                <option value="" selected>{!! __('children.select_from_list') !!}</option>
                <option value="0" {!! $child->childMother->is_mother_the_guardian == '0' ? 'selected' : '' !!}>{!! __('children.no') !!}</option>
                <option value="1" {!! $child->childMother->is_mother_the_guardian == '1' ? 'selected' : '' !!}>{!! __('children.yes') !!}</option>
            </select>
            <span class="text text-danger">

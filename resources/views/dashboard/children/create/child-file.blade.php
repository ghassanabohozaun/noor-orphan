...
<div class="row">
    ...
    <div class="col-md-3">
        <fieldset class="form-group">
            ...
            <img id="picture_of_the_orphan_child_preview" src="#" alt="{!! __('children.picture_of_the_orphan_child') !!}"
                style="display:none; height: fit-content; max-height: 200px"
    ...
    <div class="col-md-3">
        <fieldset class="form-group">
            ...
            <img id="orphan_child_birth_certificate_preview" src="#" alt="{!! __('children.orphan_child_birth_certificate') !!}"
                style="display:none; height: fit-content; max-height: 200px"
    ...
    <div class="col-md-3">
        <fieldset class="form-group">
            ...
            <img id="father_death_certificate_preview" src="#" alt="{!! __('children.father_death_certificate') !!}"
                style="display:none; height: fit-content; max-height: 200px"
    ...
    <div class="col-md-3">
        <fieldset class="form-group">
            ...
            <img id="guardian_personal_id_photo_preview" src="#" alt="{!! __('children.guardian_personal_id_photo') !!}"
                style="display:none; height: fit-content; max-height: 200px"
